...
import swu.xl.imarten.Fragment.RealFragment.TennisFloatFragment;
import swu.xl.imarten.Fragment.RealFragment.TennisGridFragment;
...
public class TennisFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragments.add(new TennisGridFragment());
        fragments.add(new TennisFloatFragment());
